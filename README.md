...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/benchling-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/benchling-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add benchling-sdk
# for installing globally
pixi global install benchling-sdk
```
...
It is possible to list all of the versions of `benchling-sdk` available on your platform:
...
```
pixi search benchling-sdk --channel conda-forge
```
